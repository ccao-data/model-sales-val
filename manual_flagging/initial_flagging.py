...
df.loc[df["nbhd"].isin(submarket1), "township_code"] = "7201"
df.loc[df["nbhd"].isin(submarket2), "township_code"] = "7202"

# Subset to only Lake data
df = df[df["township_code"].isin(["7201", "7202"])]
